...
class aspl_gift_card(models.Model):
    ...
    def _send_mail_balance_and_expired_coupon(self, expired=False, balance=False):
        ...
        template_id = self.env['ir.model.data'].get_object_reference('flexiretail_ee_advance',
                                                   'email_template_for_coupon_expire_7')
        balance_template_id = self.env['ir.model.data'].get_object_reference('flexiretail_ee_advance',
