odoo.define('flexiretail_ee_advance.models', function (require) {
"use strict";
...
models.load_fields("res.users", ['image_small','login','company_ids','access_ereceipt','access_quick_cash_payment',
                                 ...
                                 'access_change_stock_locations','access_pos_graph','access_x_report',
...
models.load_fields("res.partner", ['display_name','prefer_ereceipt','remaining_wallet_amount','credit_limit',
...
models.load_fields("product.product", ['sequence','qty_available','type','is_packaging','product_brand_id',
