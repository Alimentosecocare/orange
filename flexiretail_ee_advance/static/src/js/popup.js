odoo.define('flexiretail_ee_advance.popup', function (require) {
	"use strict";
...
//	Multi-Store Popup
	...
	var ReportPopupWidget = PopupWidget.extend({
        ...
        session_report_pdf: function(e){
        	...
        	self.pos.chrome.do_action('flexiretail_ee_advance.report_pos_inventory_session_pdf_front',{additional_context:{
        ...
        session_report_thermal: function(e){
        	var self = this;
        	var session_id = $(e.currentTarget).data('id');
        	var report_name = "flexiretail_ee_advance.front_inventory_session_thermal_report_template";
            var params = {
				model: 'ir.actions.report',
				method: 'get_html_report',
        ...
        location_report_pdf: function(e){
        	...
        	self.pos.chrome.do_action('flexiretail_ee_advance.report_pos_inventory_location_pdf_front',{additional_context:{
        ...
        location_report_thermal: function(e){
        	var self = this;
        	var location_id = $(e.currentTarget).data('id');
        	var report_name = "flexiretail_ee_advance.front_inventory_location_thermal_report_template";
            var params = {
				model: 'ir.actions.report',
				method: 'get_html_report',
