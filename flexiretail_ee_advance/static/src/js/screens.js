odoo.define('flexiretail_ee_advance.screens', function (require) {
    "use strict";
    ...
    var flexi_chrome = require('flexiretail_ee_advance.chrome')
                                                        ...
                                                        if(product.product_variant_ids && product.product_variant_ids[1]){
                                                            _.each(product.product_variant_ids, function(prod_id){
                                                                ...
                                                                if(product_pro){
                                                                    ...
                                                                    if(product_pro.id == 84975){
                                                                        console.log("product_pro >>>>> ",product_pro);
                                                                    }
...
//            			if(dateText == new moment().format('MM/DD/YYYY')){
...
//            	if(order.get_delivery_date()){
//            		min_time = order.get_delivery_date()
//            	}
                self.$("#txt_del_time").timepicker({
                    'timeFormat': 'h:i A',
                });
