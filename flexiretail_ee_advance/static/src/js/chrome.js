odoo.define('flexiretail_ee_advance.chrome', function (require) {
"use strict";
    ...
    var SliderWidget = PosBaseWidget.extend({
        ...
        init: function(parent, options){
        	...
        	self.x_report = function(){
        		...
        		self.pos.chrome.do_action('flexiretail_ee_advance.pos_x_report',{additional_context:{
        		...
        		if(self.pos.config.iface_print_via_proxy){
                    var pos_session_id = self.pos.pos_session.id;
                    var report_name = "flexiretail_ee_advance.pos_x_thermal_report_template";
                    var params = {
